...
import rutasCategoriasTorneosJugadores from './rutas/categoriasTorneosJugadores.js';
import rutasCategoriasFechas from './rutas/categoriasFechas.js';
import rutasCategoriasFechasJugadores from './rutas/categoriasFechasJugadores.js';
...
app.use('/api/categoriasTorneosJugadores', rutasCategoriasTorneosJugadores);
app.use('/api/categoriasFechas', rutasCategoriasFechas);
app.use('/api/categoriasFechasJugadores', rutasCategoriasFechasJugadores);
